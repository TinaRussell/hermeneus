...
** Front matter
:PROPERTIES:
:ID:       TKR:920c07f3-b0b6-430a-a3bf-d3b4afdcff5e
:END:
...
** Package header
:PROPERTIES:
:ID:       TKR:dc614a92-d809-40bd-8860-2481cef1d2ff
:END:
#+begin_src emacs-lisp :comments no
;; Author: Tina Russell
...
(let (current-word)
  (cl-loop for i across (seq-copy hermeneus-greek-words-beta)
           if (string-match-p (rx (category combining-diacritic))
                              (setq current-word (hermeneus-beta-to-unicode i)))
...
*** Trim a string
:PROPERTIES:
:ID:       TKR:835bcf45-1f4a-47a7-8fd7-a52531a7427e
:END:
#+begin_src emacs-lisp
...
** Testing
:PROPERTIES:
:ID:       TKR:654eb5b3-da3c-44aa-a53b-0cd49fd15648
:END:
#+begin_src emacs-lisp :tangle "hermeneus-test.el" :comments no
...
** Front matter
:PROPERTIES:
:ID:       TKR:9b2e54f6-6a02-4980-9c49-411666126640
:END:
#+begin_src emacs-lisp :comments no
...
** Utility functions
:PROPERTIES:
:ID:       TKR:fc9f22a2-ddff-4758-a2e2-b02798dcea73
:END:
#+begin_src emacs-lisp
...
** Macros
:PROPERTIES:
:ID:       TKR:d4cc8238-e2f3-4fe4-a3a9-cc285258642c
:END:
#+begin_src emacs-lisp
...
** Options
:PROPERTIES:
:ID:       TKR:f62487a8-0d91-4f0b-a35d-2fd34668f6d9
:END:
#+begin_src emacs-lisp
...
** Convert by hash
:PROPERTIES:
:ID:       TKR:137b2e54-d67e-4fe4-94b4-bb76ea9c7b0b
:END:
...
:PROPERTIES:
:ID:       TKR:d7f63fff-5539-4340-8c3e-b312af1c8880
:END:
#+begin_src emacs-lisp
...
** Normalize sigmas
:PROPERTIES:
:ID:       TKR:88c94caa-08ef-4993-8aad-f3eac89d1b03
:END:
#+begin_src emacs-lisp
...
** Conversion
:PROPERTIES:
:ID:       TKR:c46f4a38-61b2-4dd0-b0e0-54d4321ffff5
:END:
#+begin_src emacs-lisp
...
** Testing
:PROPERTIES:
:ID:       TKR:ac0367f5-9016-4139-acef-3183123bb0d6
:END:
...
** Front matter
:PROPERTIES:
:ID:       TKR:974f68c5-f091-40a2-8564-e38a2df3de94
:END:
#+begin_src emacs-lisp :comments no
...
** Dependencies
:PROPERTIES:
:ID:       TKR:584cfcc4-e766-413c-af24-10457843fa14
:END:
#+begin_src emacs-lisp
(require 'ucs-normalize)
...
** Variables
:PROPERTIES:
:ID:       TKR:1891c233-e559-4ef7-a6e2-4d3de5f16d2d
:END:
#+begin_src emacs-lisp
(hermeneus--make-regexp-versions defconst
...
** Hash tables
:PROPERTIES:
:ID:       TKR:e4580ea6-9430-414f-b91f-eeb17fb51591
:END:
#+begin_src emacs-lisp
...
** Regex builder
:PROPERTIES:
:ID:       TKR:5a761b71-feda-4241-abaa-2d85ffe2048c
:END:
Watch out for:
...
** Testing
:PROPERTIES:
:ID:       TKR:8999aa73-3aa5-46fa-be90-be901b945d1e
:END:
#+begin_src emacs-lisp :tangle "hermeneus-test.el"
...
** End matter
:PROPERTIES:
:ID:       TKR:a21aa806-4c7f-4c5b-b8b3-bfccc09a5192
:END:
#+begin_src emacs-lisp :comments no
...
** Front matter
:PROPERTIES:
:ID:       TKR:1c8a8fb3-dc9e-48e4-a8c9-a6ef6b611ced
:END:
#+begin_src emacs-lisp :comments no
...
; (which is run by the defcustom below it)

(cl-defun hermeneus--set-storage-dir (&optional (symbol 'hermeneus-storage-dir)
                                                (value (if (boundp 'hermeneus-storage-dir)
                                                           hermeneus-storage-dir
                                                         (expand-file-name "var/hermeneus" user-emacs-directory))))
  "Setter function for option ‘hermeneus-storage-dir’."
...
you set this outside Customize, be sure to evaluate the function
‘hermeneus--set-storage-dir’."
  :type 'directory
  :tag "Hermeneus — storage directory"
  :group 'hermeneus
  :set #'hermeneus--set-storage-dir)
#+end_src
...
** Testing
:PROPERTIES:
:ID:       TKR:98034f7e-a248-4c5a-a6d5-69b803a991c8
:END:
#+begin_src emacs-lisp :tangle "hermeneus-test.el"
...
** Front matter
:PROPERTIES:
:ID:       TKR:8ef9d318-a3ac-4b7e-a301-ddb1e71d1a15
:END:
#+begin_src emacs-lisp :comments no
...
:PROPERTIES:
:ID:       TKR:4a6f55ba-0e8f-4bf1-80aa-86b4d1cf6061
:END:
#+begin_src emacs-lisp
...
*** Does the current Emacs support libxml2?
:PROPERTIES:
:ID:       TKR:a1918fd7-545d-4252-90e9-60dfcbfefabb
:END:
This is here because Emacs 26 (the earliest Emacs supported by Hermeneus) doesn’t have the function ~libxml-available-p~. If we ever drop support for Emacs 26, we can simply use ~libxml-available-p~ instead of this.
...
*** LSJ files
:PROPERTIES:
:ID:       TKR:01e2f714-3f52-4049-b057-4d3618c7a2af
:END:
...
*** Which function will we use to parse XML?
:PROPERTIES:
:ID:       TKR:22bb245e-850e-40aa-8104-3b8a167268d2
:END:
...
:PROPERTIES:
:ID:       TKR:03c78954-db65-47a8-9e2f-111a0d331ee0
:END:
#+begin_src emacs-lisp
...
** Testing
:PROPERTIES:
:ID:       TKR:6a32401f-f9e7-4e52-9c47-65cc722cb2ba
:END:

We’ll need to use ~let~ to shadow some variables to prevent the tests from clobbering actual values and files the user may have stored.
...
** Front matter
:PROPERTIES:
:ID:       TKR:86ea32d7-c7e2-4b38-aae4-155d6c358688
:END:
#+begin_src emacs-lisp :comments no
...
** TODO Testing
:PROPERTIES:
:ID:       TKR:ba63b06f-cf08-4ff1-9b1f-eed5387a6a47
:END:
#+begin_src emacs-lisp :tangle "hermeneus-test.el"
#+end_src
...
** Front matter
:PROPERTIES:
:ID:       TKR:cc113d67-8b69-4365-8dbd-e297ae042830
:END:
#+begin_src emacs-lisp :comments no
...
** Variables
:PROPERTIES:
:ID:       TKR:381cf97b-9b75-471a-a25c-eb82f16d3417
:END:
#+begin_src emacs-lisp
...
*** Convert URNs
:PROPERTIES:
:ID:       TKR:263e9918-cdaf-4218-a60a-f39fc095324b
:END:
#+begin_src emacs-lisp
...
** TODO Testing
:PROPERTIES:
:ID:       TKR:2f830a16-8963-4182-a998-c45bfa2401c1
:END:
#+begin_src emacs-lisp :tangle "hermeneus-test.el"
...
** End matter
:PROPERTIES:
:ID:       TKR:b581329f-b6d5-4d0e-9817-71d70ecff1d4
:END:
#+begin_src emacs-lisp :comments no
...
** Front matter
:PROPERTIES:
:ID:       TKR:c138c657-c54c-47e5-a18e-0d712388bcac
:END:
#+begin_src emacs-lisp :comments no
...
** Options
:PROPERTIES:
:ID:       TKR:17600f25-f72c-49fb-9fcb-dc7497e16687
:END:
#+begin_src emacs-lisp
...
** TODO Testing
:PROPERTIES:
:ID:       TKR:0822da09-649c-47fe-96ec-e53bb1ff6043
:END:
#+begin_src emacs-lisp :tangle "hermeneus-test.el"
#+end_src
...
** Front matter
:PROPERTIES:
:ID:       TKR:26d1a990-ce33-4169-82bf-ff0e71db22ef
:END:
#+begin_src emacs-lisp :comments no
...
*** Local variables
:PROPERTIES:
:ID:       TKR:9b55011d-c094-407f-9320-8928e2d3043f
:END:
#+begin_src emacs-lisp
...
:PROPERTIES:
:ID:       TKR:1b45d816-5cc7-441a-b9cb-70863a09ba98
:END:
#+begin_src emacs-lisp
...
** TODO Testing
:PROPERTIES:
:ID:       TKR:616b86f6-97e1-4eef-b5f6-4d34c45a492b
:END:
#+begin_src emacs-lisp :tangle "hermeneus-test.el"
#+end_src
...
** Testing
:PROPERTIES:
:ID:       TKR:96d2cc57-bf6d-4024-b4ee-d6bb2703763d
:END:
#+begin_src emacs-lisp :tangle "hermeneus-test.el" :comments no
